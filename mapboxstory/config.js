var config = {
    ...
    theme: 'dark',
    alignment: 'left',
    title: 'DYSTOPIAN <br/> DEFORESTATION',
    byline: '',
    footer: '',
    animation: 'fadein',
    chapters: [
        {
            ...
            description: 'What would a map of the Earth look like if all the sub-tropical rainforests were deforested in a day? <br/> </p> </p> Making up one thirf of around Philadelphia on two horse around the field. This not going to work is it? Footbal pitch idea?  </br> </p> </br> <p><strong> SCROLL DOWN <p><strong> With each scroll YOU are taking an ACTION</p>',
