    ...
    chapters: [
        {
            ...
            description: ' ________________________________ <br/> BY JONNI WALKER | JANUARY, 2020 <br/> </p> </p> </p> <img src="https://www.jonniwalkerdatablog.com/wp-content/uploads/2020/01/world.200409.3x5400x2700-1.png" style=height:95px;width:200px> </br> </p> What would a map of the Earth look like if all the sub-tropical rainforests were deforested in a day? <br/></p> Making up one thirf of around Philadelphia on two horse around the field and with that the bilbo went to the woods.<br/></p> Making up one thirf of around Philadelphia on two horse around the field. <br/> </p>SCROLL DOWN<br/></p><img src="https://www.jonniwalkerdatablog.com/wp-content/uploads/2020/01/Scroll-White-1.gif"><br/>  <br/> </p> <img src=""><img src=""><img src=""> </p> </p>  </br>',
            image: '', 
      ...
      opacity: 0.54
        ...
        },
        {
            ...
            description: '________________________________ Philaun, the public transit infrastructun driving (and parking)and cheat and yarn and bilbo and frodo and golum the vapour boy and dogs and Finn and Allan and Anya  </br> </p> • Democratic Republic of Congo <strong> 6.8M </strong> </br> </p> LOCATION MAP </p> </p>',
            location: {
